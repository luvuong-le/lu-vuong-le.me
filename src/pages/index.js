...
const IndexPage = () => {
    ...
    useEffect(() => {
        const typedJSOptions = {
            strings: ['<i>> Software Engineer</i>', '<i>> Mentor</i>', '<i>> Designer</i>'],
            typeSpeed: 40,
            loop: true
        };
                ...
                <Container>
                    <div className="landing">
                        <div className="landing__header">
                            <h2>Welcome! <span class="anim anim--wave margin-l-sm" role="img" aria-label="jsx-a11y/accessible-emoji">👋</span></h2>
                        ...
                        <div className="landing__body">
                            <div className="flex">
                                ...
                                <p>I create efficient solutions for companies</p>
                            </div>
